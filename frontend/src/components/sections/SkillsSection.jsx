...
export default function SkillsSection() {
  ...
  return (
    <section id="skills" className="relative bg-dark overflow-hidden py-24 w-full">
      ...
      {/* Header Container (Constrained aligned layout) */}
      ...
      {loading ? (
        ...
        /* Full Width Edge-to-Edge Scrolling tracks (Outside constrained max-width container) */
        <div className="space-y-10 py-4 overflow-hidden relative w-full z-10">
          
          {/* ROW 1: Frontend (Slides Left) */}
          {frontendSkills.length > 0 && (
            <div className="relative w-full overflow-hidden py-2.5 border-y border-white/5 bg-[#111]/30">
          ...
          {backendSkills.length > 0 && (
            <div className="relative w-full overflow-hidden py-2.5 border-b border-white/5 bg-[#111]/30">
